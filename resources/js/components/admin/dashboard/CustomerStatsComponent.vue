        ...
        <div class="db-card">
            <div class="db-card-header">
                ...
                <div id="customer-range" class="cursor-pointer flex items-center gap-3">
                    <Datepicker hideInputIcon autoApply :enableTimePicker="false" utc="false" :placeholder="$t('label.select_date_range')"
                        @update:modelValue="customerStates" v-model="modelValue" :range="true">
                    </Datepicker>
                </div>
            </div>
