        ...
        <div id="product" class="db-tab-div active">
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 mb-5">
                ...
                <div class="relative w-full">
                    ...
                    <div :class="{ 'scale-y-100': tabMore == true, 'scale-y-0': tabMore == false }"
                        ...
                        <div class="form-row py-2">
                            <div class="form-col-12 sm:form-col-6">
                                ...
                                <div class="db-field-radio-group">
                                    ...
                                    <div class="db-field-radio">
                                        ...
                                        <label for="flat_rate" class="db-field-label">{{ $t('label.flat_rate') }}</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-col-12 sm:form-col-6 mb-2"
                                ...
                                <div class="db-field-radio-group">
                                    <div class="db-field-radio">
                                        <div class="custom-radio">
                                            <input type="radio" v-model="shippingAndReturnForm.is_product_quantity_multiply"
                                    ...
                                    <div class="db-field-radio">
                                        ...
                                        <label for="quantityMultiplyNo" class="db-field-label">{{ $t('label.no') }}</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-col-12">
                                ...
                                <div :class="shippingError.shipping_and_return ? 'invalid textarea-error-box-style' : ''">
                                    <quill-editor id="description" v-model:value="shippingAndReturnForm.shipping_and_return"
